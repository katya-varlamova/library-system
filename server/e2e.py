...
class TestMain(unittest.TestCase):
  ...
  def test_login(self):
    ...
    r = requests.get("https://127.0.0.1:8000//api/v2/accounts",
  ...
  def test_get_books(self):
    ...
    r = requests.get("https://127.0.0.1:8000//api/v2/books",
  ...
  def test_get_libs(self):
    ...
    r = requests.get("https://127.0.0.1:8000//api/v2/libraries",
                 headers=headers, params = params, verify=False)
